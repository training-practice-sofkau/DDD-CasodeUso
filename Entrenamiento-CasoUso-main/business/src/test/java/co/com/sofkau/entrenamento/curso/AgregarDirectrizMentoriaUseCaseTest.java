...
public class AgregarDirectrizMentoriaUseCaseTest {
    ...
    void agregarDirectrizHappyPass(){
        ...
        assertEquals("nnn", event.getDirectiz().value());
    ...
    private List<DomainEvent> history() {
        ...
        var curso = new CursoCreado(
                nombreCurso,
                descripcion
        );
        curso.setAggregateRootId(cursoId.value());
        var mentoria = new MentoriaCreada(
                mentoriaId,
                nombreMentoria,
                fecha
        );
        mentoria.setAggregateRootId("ddddd");
        return List.of(curso, mentoria);
    }
}
